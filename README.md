...
|---|---|
| Arthur Reis | Estrutura do simulador|
| Luísa Fischer | Instruções |
| Sofia Villela | Instruções |
...
Caso queira compilar manualmente, basta ter um compilador C, como o GCC, abrir o terminal na pasta do projeto e executar o comando:
...
A saída deve mostrar uma linha por instrução e terminar com:

```text
Resultado: 5! = 120 (MEM[0x20])
```
OBS: Se quiser você pode alterar o N no main.c e a saída final irá mudar de acordo com o novo valor.
...
- Material do professor Ronierison: `CPU_Atividade.pdf`, das seções 3 a 6 e desafio do Grupo 3 (Fatorial).
